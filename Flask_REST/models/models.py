...
class ChannelModel(db.Model):
    ...
    articles = db.relationship("ArticleModel", secondary=ass_table, back_populates="channels")
...
class ArticleModel(db.Model):
    ...
    channels = db.relationship("ChannelModel", secondary=ass_table, back_populates="articles")
